...
import { AnswerPreferencesStore, createAnswerPreferencesSlice } from '@/stores/slices/answerPreferencesSlice';
...
export type StoreState = CitationsStore & ConversationStore & FilesStore & ParamStore & AnswerPreferencesStore;
...
const useStore = create<StoreState>((...a) => ({
  ...
  ...createFilesSlice(...a),
  ...createParamsSlice(...a),
  ...createAnswerPreferencesSlice(...a),
}));

export const useAnswerPreferencesStore = () => {
  return useStore(
    (state) => ({
      answerPreferences: state.answerPreferences,
      answerPreferencesSwitches: state.answerPreferencesSwitches,
      setDetailLevel: state.setDetailLevel,
      setFormality: state.setFormality,
      setAskQuestions: state.setAskQuestions,
    }),
    shallow
  );
};
